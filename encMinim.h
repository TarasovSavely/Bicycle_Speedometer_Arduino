...
#ifndef encMinim_h
#define encMinim_h
#define _ME_ENC_FAST 1       // таймаут быстрого поворота
...
{
public:
  encMinim(uint8_t clk, uint8_t dt, int8_t sw, boolean dir);
...
encMinim::encMinim(uint8_t clk, uint8_t dt, int8_t sw, boolean dir) {
  if (dir) {
    _clk = clk;
    _dt = dt;
  } else {
